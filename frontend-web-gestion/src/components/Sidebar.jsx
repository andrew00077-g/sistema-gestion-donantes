...
import { LayoutDashboard, Users, Droplets, Bell, LogOut, UserPlus } from 'lucide-react';

const Sidebar = () => {
  const navigate = useNavigate();
  const location = useLocation();

  // Mapeamos los ítems con sus respectivas rutas de React Router
  const menuItems = [
    ...
    { icon: <Droplets size={20}/>, label: 'Inventario Sangre', path: '/inventario' }, // Apunta a la ruta de inventario
